    ...
    <article class="card" @click="toStudio($event, data.id)">
        <div class="card--inner">
            ...
            <template v-for="type in Object.values(data.studio_type)">
                <p v-if="optionsStudios && optionsStudios.studio_type" :key="type" class="card--studio-type">
                    {{ optionsStudios.studio_type[type] }}
                </p>
            </template>
            <div class="card--row">
                <div v-for="icon in Array.from(data.working_with_model_types)" :key="icon" class="card--model_types">
                    <img :src="require(`../assets/svg/i-${icon}.svg`)">
                </div>
                <template v-if="optionsStudios && optionsStudios.models_age">
                    <div v-for="age in Object.values(data.models_age)" :key="age" class="card--models_age">
        ...
        <p class="card--address" :class="{ 'card--address-with-certificate': data.certified }">
            {{ data.address }}
        </p>
