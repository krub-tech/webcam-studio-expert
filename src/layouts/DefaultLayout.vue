<template>
    <div class="layout-wrapper">
        ...
        <transition name="modal">
            <div v-if="$store.state.modals.modal" class="modal-wrapper">
                <div class="modal-wrapper--inner">
                    <component :is="$store.state.modals.modal.name" v-if="!$store.state.modals.isSent" />
                    <ModalSendSuccess v-if="$store.state.modals.isSent" />
                    <button v-if="closeBtnIsShow" class="close-btn" @click="closeModal" />
                </div>
            </div>
        </transition>
        <Footer />
...
export default {
  ...
  computed: {
    closeBtnIsShow() {
      return !this.$store.state.modals.isSent;
    },
  },
  updated() {
